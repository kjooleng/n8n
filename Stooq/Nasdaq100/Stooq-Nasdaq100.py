...
stocks_list = pd.read_csv("Nasdaq100.csv")
stocks = list(stocks_list["<TICKER>"])
tickers = stocks

name_list = pd.read_csv("Nasdaq100.csv")
...
path = "/files/Stooq/Nasdaq100/"
df.to_csv(path + f"US STOOQ Nasdaq100 quotes {getdate}.csv")
...
if still_failed:
    log_path = "/files/Stooq/Nasdaq100/Nasdaq100_failed_tickers.txt"
