...
stocks_list = pd.read_csv("Dow30.csv")
stocks = list(stocks_list["<TICKER>"])
tickers = stocks

name_list = pd.read_csv("Dow30.csv")
...
path = "/files/Stooq/Dow30/"
df.to_csv(path + f"US STOOQ Dow30 quotes {getdate}.csv")
...
if still_failed:
    log_path = "/files/Stooq/Dow30/Dow30_failed_tickers.txt"
