...
tickers = ["WPM", "RGLD", "GDX", "GDXJ"]
names = ["Wheaton Precious Metals", "Royal Gold", "VanEck Vectors Gold Miners ETF", "VanEck Vectors Junior Gold Miners ETF"]
