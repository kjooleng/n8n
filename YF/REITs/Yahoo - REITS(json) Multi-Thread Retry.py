...
tickers = ["WRE", "FPI", "CCI", "RYN", "PSLV"]
names = ["Washington Real Estate Investment Trust", "Farmland Partners", "Crown Castle", "Rayonier", "Sprott Physical Silver Trust"]
