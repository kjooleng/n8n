...
tickers = ["DX-Y.NYB", "^GSPC", "^DJT", "^DJI", "^IXIC", "^VIX"]
names = ["US Dollar Index", "S&P 500", "DOW JONES TRANS", "Dow Jones Industrial Average", "NASDAQ Composite", "CBOE Volatility Index"]

tickers = ["DX-Y.NYB", "^GSPC", "^DJT", "^DJI", "^IXIC", "^VIX", "^HSI", "^STI", "^N225"]
names = ["US Dollar Index", "S&P 500", "DOW JONES TRANS", "Dow Jones Industrial Average", "NASDAQ Composite", "CBOE Volatility Index", "Hang Seng Index", "Straits Times Index", "Nikkei 225"]
...
output_path = "/files/Yahoo/Indices/"
